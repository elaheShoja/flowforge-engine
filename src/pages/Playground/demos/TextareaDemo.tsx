...
export default function TextareaDemo() {
  const [resize, setResize] =
    useState<"none" | "vertical" | "horizontal" | "both">(
      "vertical"
    );
    ...
    <div className="playground-stack">
      ...
      <section className="playground-section">
        ...
        <div className="playground-section__header">
          ...
          <p>
            Experiment with the main Textarea
            properties and see the result immediately.
          </p>
        </div>
      ...
      <section className="playground-section">
        ...
        <div className="playground-section__header">
          ...
          <p>
            A multiline text input for longer
      ...
      <section className="playground-section">
        ...
        <div className="playground-section__header">
          ...
          <p>
            Control the initial height of the
            textarea using the rows property.
          </p>
        </div>
      ...
      <section className="playground-section">
        ...
        <div className="playground-section__header">
          ...
          <p>
            Automatically adjust the textarea
            height based on its content.
          </p>
        </div>
      ...
      <section className="playground-section">
        ...
        <div className="playground-section__header">
          ...
          <p>
            Control how the user can manually
            resize the textarea.
          </p>
        </div>
      ...
      <section className="playground-section">
        ...
        <div className="playground-section__header">
          ...
          <p>
            Common Textarea states used in
            FlowForge forms.
          </p>
        </div>
      ...
      <section className="playground-section">
        ...
        <div className="playground-section__header">
          ...
          <p>
            Compare content-width and full-width
            textarea layouts.
          </p>
        </div>
